<?php snippet('header') ?>
  ...
  <main>
    <section class="content content--full flexy intro" style="background:#B9D6F2">
      <h2 class="content__title content__title--center">
        <div id="rev-1" class="content__title__inner">Lorem ipsum</div><br/>
        <div id="rev-2" class="content__title__inner content__title__inner--offset-1">dolor sit amet</div>
      </h2>
    </section>

    <div class="parallax hidden-mobile" style="background:url('http://placehold.it/1920x1080')">
      <div class="parallax-cover">

      </div>
    </div>
    <div class="parallax hidden-desktop" style="background:url('http://placehold.it/720x1080')">
      <div class="parallax-cover">
